...
module.exports = {   
    ...
    add:function(req,res){
        var return_obj = {};
        return_obj.link_to_submit = "/api/Ef_envir";   
    ...
    edit:function(req,res){
        ...
        //避免被injection 
        Ef_envir.findOne({ef_envir_pk:params.envir_pk}).exec(function(err,find_data){
            if(err){
                res.notFound();
            }else{
                //資料處理
    ...
    delete:function(req,res){        
        var params = req.allParams();        
        var destroy_url = "/api/Ef_envir?type=D&envir_pk="+params.envir_pk+"&submit_to_link=/envir/list/";
