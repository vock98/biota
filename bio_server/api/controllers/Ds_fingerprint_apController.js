...
module.exports = {
    ...
    */
    ...
    /*
        ...
        快速連結 : http://localhost:1337/api/Ds_fingerprint_device/search_human?id=1
    */
	search_human: function(req, res) {
        ...
        if(params.ds_ap_id){
            ...
            no_call_service.write_log(table_name,"R1_die", params, req.session.id, log_type);
    ...
    /*
        ...
        輸入 : ds_ap_id
        輸出 : 整個DB查到的資料
        快速連結 : http://localhost:1337/api/Ds_fingerprint_device/search_by_id?ds_ap_id=1
    */
